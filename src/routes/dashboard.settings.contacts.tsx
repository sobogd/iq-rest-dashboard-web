...
export const Route = createFileRoute("/dashboard/settings/contacts")({
  component: ContactsSettingsPage,
});

function ContactsSettingsPage() {
  return (
