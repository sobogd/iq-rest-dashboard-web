...
export const Route = createFileRoute("/dashboard/items/new")({
...
function NewItemPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-xl font-medium text-neutral-900 mb-3">New dish</h1>
      <div className="bg-white border border-neutral-200 rounded-xl p-8 text-center text-sm text-neutral-500">
        Category {categoryId} — form coming soon.
      </div>
    </div>
  );
}
