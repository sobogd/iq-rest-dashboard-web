...
export const ArrowRightIcon = (p: IconProps) => svg({ ...p, children: <>
 <line x1="5" y1="12" x2="19" y2="12" />
 <polyline points="12 5 19 12 12 19" />
</> });

export const ArrowLeftIcon = (p: IconProps) => svg({ ...p, children: <>
...
export const GlobeIcon = (p: IconProps) => svg({ ...p, children: <>
 <circle cx="12" cy="12" r="10" />
